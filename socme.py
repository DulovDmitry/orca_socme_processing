...
# Создаем субплоты
ax1 = fig.add_subplot(gs[0:3])  # график heatmap
ax2 = fig.add_subplot(gs[1])  # энергетическая диаграмма
...
class SocmeReader:
    ...
    def calculate_parameters(self):
        self.delta_E_ST = self.S1_energy - self.T1_energy
        # self.kRISC = self.T1_S1_SOCME_eV ** 2 * np.exp(-(self.delta_E_ST ** 2))
